...
def evaluation_4class(prediction, y):
    TP1, FP1, FN1, TN1 = 0, 0, 0, 0
    TP2, FP2, FN2, TN2 = 0, 0, 0, 0
...
def evaluation_3class(prediction, y):
    TP1, FP1, FN1, TN1 = 0, 0, 0, 0
    TP2, FP2, FN2, TN2 = 0, 0, 0, 0
    TP3, FP3, FN3, TN3 = 0, 0, 0, 0
...
def write2Predict_oneVSall(prediction, y, resultPath):
...
def write2Predict_4class(prediction, y, resultPath):
    fout = open(resultPath, 'w')
    for i in range(len(y)):
